        ...
        <main class="ml-0 md:ml-64 flex-1 p-4 md:p-8 w-full">
            ...
            <header class="mb-7">
                <nav class="text-sm text-gray-500 mb-2">
                    <span>Trang chủ</span> / <span class="text-gray-700">tai khoan</span>
                </nav>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100">
                                ...
                                <th class="px-6 py-4 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">loai tai khoan</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($user as $row) { ?>
                                <tr class="hover-row border-b border-gray-50 hover:bg-blue-50/50 hover:shadow-inner">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php if ($row['role'] == 1) {
                                                                                                                    echo 'admin';
                                                                                                                } else {
                                                                                                                    echo 'nguoi dung';
                                                                                                                }
