...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" id="formAdd" enctype="multipart/form-data">
            ...
            <input type="text" id="ten_tour" name="ten_san_pham" placeholder="Tên san pham">
            <small id="errorName"></small>

            <input type="number" id="gia" name="gia" placeholder="Giá san pham">
            <small id="errorPrice"></small>

            <input type="number" id="so_luong" name="so_luong" placeholder="Giá so luong">
            <small id="errorSoLuong"></small>

            <textarea id="mo_ta" name="mo_ta" placeholder="Mô tả "></textarea>
            <small id="errorMoTa"></small>

            <select name="loai_hang" id="ten_danh_muc">
                <option value="">-- Chọn loai hang --</option>
            ...
            <small id="errorChon"></small>

            <input type="file" id="hinh_anh" name="hinh anh" placeholder="hinh anh">
