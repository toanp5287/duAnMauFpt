            ...
            <div class="adm-card p-5 sm:p-8 max-w-2xl mx-auto lg:mx-0">
                ...
                <form method="POST" id="formAdd" enctype="multipart/form-data" class="space-y-4" novalidate>
                    ...
                    <div>
                        ...
                        <?php $field = 'loai_hang_id';
                        $inputId = 'ten_danh_muc';
                        include __DIR__ . '/components/form-error.php'; ?>
                    </div>
                ...
                <a href="index.php?controller=san_pham&action=index" class="adm-btn-secondary w-full h-11 mt-4 text-center">Quay lại trang</a>
            </div>
        </main>
    </div>
