...
<body class="font-sans bg-slate-50 text-slate-700 antialiased">
    ...
    ">
                                        ...
                                        <span id="toggleReviewsText">
                                            Xem thêm đánh giá
                                        </span>

                                        <svg
                                            id="toggleReviewsIcon"
        ...
        =============================== -->
                ...
                =============================== -->
                            <form
                                action="index.php?controller=chi_tiet&action=insertRV"
                                method="POST"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        class="<?= form_input_class(
                                                    $errors ?? [],
                                                    'so_sao',
                                                    'ds-input h-10 px-3 text-sm cursor-pointer'
                                                ) ?>"
                                        <?= form_field_attrs(
                                            $errors ?? [],
                                            'so_sao',
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        class="<?= form_input_class(
                                                    $errors ?? [],
                                                    'danhGia',
                                                    'ds-input px-3 py-2.5 text-sm min-h-[100px] resize-none'
                                                ) ?>"
                                        <?= form_field_attrs(
                                            $errors ?? [],
                                            'danhGia',
                                            'danhGia'
                                        ) ?>><?= form_old_value('danhGia') ?></textarea>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const toggleButton =
            document.getElementById('toggleReviews');

        const toggleText =
            document.getElementById('toggleReviewsText');

        const toggleIcon =
            document.getElementById('toggleReviewsIcon');
